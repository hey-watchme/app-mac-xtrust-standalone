...
public final class SQLiteSessionStore: OrganizationStore, WorkspaceStore, DeviceStore, AccountStore, OrganizationMembershipStore, AccessSessionStore, SessionStore, TopicStore, UtteranceStore, RecordingArtifactStore, TranscriptArtifactStore, TranscriptionJobStore, @unchecked Sendable {
